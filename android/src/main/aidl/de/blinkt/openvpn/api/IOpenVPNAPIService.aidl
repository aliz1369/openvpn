...
interface IOpenVPNAPIService {
	...
	void startVPN (String inlineconfig, String callingApp);
    ...
    /** Use a profile with all certificates etc. embedded */
    APIVpnProfile addNewVPNProfile (String name, boolean userEditable, String config, String callingPackage);
    APIVpnProfile addNewVPNProfileWithData (String name, boolean userEditable, String config, String username, String password, String callingPackage);
}