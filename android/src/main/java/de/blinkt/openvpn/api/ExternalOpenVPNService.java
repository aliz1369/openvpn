...
import com.reactnativeopenvpn.R;
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub()   {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), getApplicationContext().getClass());
        ...
        public void startVPN(String inlineConfig, String callingApp) throws RemoteException {
        ...
        @Override
        public APIVpnProfile addNewVPNProfile(String name, boolean userEditable, String config, String callingPackage) throws RemoteException {
            return addNewVPNProfileWithData(name, userEditable, config, null, null, callingPackage);
        }


        @Override
        public APIVpnProfile addNewVPNProfileWithData(String name, boolean userEditable, String config, String username, String password, String callingPackage) throws RemoteException {
            ConfigParser cp = new ConfigParser();
            try {
                cp.parseConfig(new StringReader(config));
                VpnProfile vp = cp.convertProfile();
                if(username != null) {
                    ConfigParser.useEmbbedUserAuth(vp, username + '\n' + (password != null ? password : ""));
                }
                vp.mName = name;
