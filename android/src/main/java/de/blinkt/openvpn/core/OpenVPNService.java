...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    private static final String RESUME_VPN = "com.reactnativeopenvpn.RESUME_VPN";
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            //noinspection NewApi
            mNotificationManager.createNotificationChannel(createNotificationChannel(channel, desc, importance, color));
    ...
    private NotificationChannel createNotificationChannel(String channelId, String channelName, int importance, int color) {
